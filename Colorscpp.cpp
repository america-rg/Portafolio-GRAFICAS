...
int main()
{
    ...
    float verticesTriangulosColores[] = {
        /////////x,y,z          colores r,g,b
            ...
            0.0f, 0.5f, 0.0f,   0.944, 0.414, 0.207,  // 1
            0.5f, -0.0f, 0.0f, 1, 0, 0,  // 2 

            -0.5f, -0.0f, 0.0f,   1, 0, 0,  // 3
            0.0f, -0.5f, 0.0f,   0.474, 0.207, 0.207, // 4
            0.5f,  0.0f, 0.0f, 1, 0, 0,   // 5

            -0.5f,  -0.0f, 0.0f, 1, 0, 0,        // 6
            -0.9f,  0.5f, 0.0f,  0.474, 0.207, 0.207,       // 7
            0.0f,  0.5f, 0.0f, 1, 0, 0,        // 8

            0.5f,  -0.0f, 0.0f,  1, 0, 0, //9
            0.9f,  0.5f, 0.0f,  0.474, 0.207, 0.207, //10
            0.0f, 0.5f, 0.0f,  1, 0, 0,//11

            -0.9f,  0.5f, 0.0f,  0.474, 0.207, 0.207,  //12
            -0.5f,  0.9f, 0.0f,  0.474, 0.207, 0.207,  //13
            0.0f, 0.5f, 0.0f,  1, 0, 0,  //14

            0.0f, 0.5f, 0.0f,  1, 0, 0,//15
            0.9f,  0.5f, 0.0f,  0.474, 0.207, 0.207,  //16
            0.5f,  0.9f, 0.0f, 0.474, 0.207, 0.207,   //17
